...
csv_file = os.path.join(script_dir, '图5-2fixed.csv')
output_path = os.path.join(script_dir, '图5-2_grouped_bar.png')
...
# 设置对应 X Label 的特殊颜色 (PG-MoE蓝, 另外两个黑)
